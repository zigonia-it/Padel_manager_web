...
- [ ] Generic point/margin engine. — in the 1.0 scope (developer, 2026-09-21); **planned 2026-09-24, not built**: a "points" scoring mode (first to N points, win by M, optional cap) next to padel scoring, reusing the existing result structure. Plan, phases, risks and open decisions: `docs/technical/scoring-engine-plan.md`.
