...
`node --test` (unit and page-structure tests) and the database tests in `supabase/tests/*.pglite.mjs`. `scripts/ui-audit.js` is a layout audit to run in the browser console against the local preview (see `docs/ROADMAP.md` Phase 25).
