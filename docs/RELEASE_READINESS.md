...
Status at 0.16.0, 2026-09-20 (first written at 0.9.0 on 2026-09-19). `1.0.0` is **not** released: the checklist below still has open items and the developer has to approve the version change.
...
| Production build | verified | Vercel serves 0.16.0 (`/api/health`), the new pages and assets answer 200 (checked after every merge) |
