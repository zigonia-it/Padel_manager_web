...
The actual current development baseline is `0.9.1` (the 0.9.1 bug-fix batch, 2026-09-20; `0.9.0` was applied 2026-09-19 under the developer's standing authorization to bump fully verified milestones; `docs/CHANGELOG.md` lists what was verified and what still awaits a person on real devices). `0.7.0` was the beta feature milestone.
