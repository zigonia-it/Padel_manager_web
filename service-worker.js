const cacheName = "padelstar-v282";
...
const appShell = [
  ...
  "./styles/components.css?v=padelstar-components-17",
  ...
  "./styles/modules.css?v=padelstar-modules-13",
  "./styles/styles.css?v=padelstar-ui-101",
  "./styles/responsive.css?v=padelstar-responsive-1",
  "./styles/ui-consistency.css?v=padelstar-ui-consistency-44",
  ...
  "./styles/create-wizard.css?v=padelstar-create-wizard-1",
  ...
  "./app/translations.js?v=padelstar-i18n-29",
  ...
  "./app/setup-forms.js?v=padelstar-setup-forms-4",
  ...
  "./app/guide-i18n.js?v=padelstar-guide-i18n-2",
  ...
  "./app/court-queue.js?v=padelstar-court-queue-2",
  ...
  "./app/match-list.js?v=padelstar-match-list-2",
  ...
  "./app/profile-ui.js?v=padelstar-profile-ui-2",
  ...
  "./app/profile-session.js?v=padelstar-profile-session-2",
  ...
  "./app/bootstrap/dom-elements.js?v=padelstar-dom-elements-8",
  ...
  "./app/ui/app-renderer.js?v=padelstar-app-renderer-2",
  "./app/match-card.js?v=padelstar-match-card-2",
  "./app/backup-format.js?v=padelstar-backup-format-2",
  "./app/link-utils.js?v=padelstar-link-utils-2",
  "./app/tournament-state.js?v=padelstar-tournament-state-3",
  "./app/state-bootstrap.js?v=padelstar-state-bootstrap-1",
  "./app/module-routing.js?v=padelstar-module-routing-3",
  ...
  "./app/app-events.js?v=padelstar-app-events-3",
  "./app/workspace-events.js?v=padelstar-workspace-events-1",
  "./app/tournament-entry.js?v=padelstar-tournament-entry-4",
  "./app/create-wizard.js?v=padelstar-create-wizard-1",
  ...
  "./app/app.js?v=padelstar-session-56",
  "./supabase-config.js",
