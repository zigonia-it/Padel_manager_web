...
const appShell = [
  ...
  "./styles/podium.css?v=padelstar-podium-2",
  "./styles/privacy.css?v=padelstar-privacy-3",
  "./app/translations.js?v=padelstar-i18n-27",
  ...
  "./app/podium.js?v=padelstar-podium-2",
  ...
  "./app/bootstrap/dom-elements.js?v=padelstar-dom-elements-6",
  ...
  "./app/app.js?v=padelstar-session-50",
  "./supabase-config.js",
