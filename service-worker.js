...
const appShell = [
  ...
  "./app/translations.js?v=padelstar-i18n-28",
  ...
  "./app/setup-forms.js?v=padelstar-setup-forms-3",
  ...
  "./app/bootstrap/dom-elements.js?v=padelstar-dom-elements-7",
  ...
  "./app/tournament-state.js?v=padelstar-tournament-state-2",
  ...
  "./app/app-events.js?v=padelstar-app-events-2",
  "./app/workspace-events.js?v=padelstar-workspace-events-1",
  "./app/tournament-entry.js?v=padelstar-tournament-entry-3",
  ...
  "./app/app.js?v=padelstar-session-55",
  "./supabase-config.js",
