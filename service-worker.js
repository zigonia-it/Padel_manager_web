const cacheName = "padelstar-v349";
...
const appShell = [
  ...
  "./styles/components.css?v=padelstar-components-20",
  "./styles/tv.css?v=padelstar-tv-16",
  "./styles/tv-light.css?v=padelstar-tv-light-2",
  "./styles/tv-light-manual.css?v=padelstar-tv-light-manual-1",
  ...
  "./styles/responsive.css?v=padelstar-responsive-5",
  "./styles/ui-consistency.css?v=padelstar-ui-consistency-52",
  ...
  "./styles/lobby.css?v=padelstar-lobby-4",
  ...
  "./styles/theme-light.css?v=padelstar-theme-light-9",
  "./styles/theme-light-manual.css?v=padelstar-theme-light-manual-2",
  ...
  "./styles/privacy.css?v=padelstar-privacy-6",
  "./app/translations.js?v=padelstar-i18n-57",
  ...
  "./app/privacy-i18n.js?v=padelstar-privacy-i18n-8",
  ...
  "./app/tournament-runtime.js?v=padelstar-tournament-runtime-3",
  ...
  "./app/lobby.js?v=padelstar-lobby-4",
  ...
  "./app/profile-ui.js?v=padelstar-profile-ui-4",
  "./app/backup-ui.js?v=padelstar-backup-ui-2",
  "./app/player-replacement.js?v=padelstar-player-replacement-2",
  "./app/player-withdrawal.js?v=padelstar-player-withdrawal-1",
  "./app/player-state.js?v=padelstar-player-state-4",
  ...
  "./app/workspace-rail.js?v=padelstar-workspace-rail-3",
  ...
  "./app/color-mode.js?v=padelstar-color-mode-1",
  ...
  "./app/system-admin.js?v=padelstar-system-admin-2",
  "./app/invitations.js?v=padelstar-invitations-2",
  "./styles/system-admin.css?v=padelstar-system-admin-2",
  "./admin.html",
  ...
  "./app/bootstrap/dom-elements.js?v=padelstar-dom-elements-14",
  "./app/bootstrap/app-meta.js?v=padelstar-app-meta-9",
  ...
  "./app/result-correction.js?v=padelstar-result-correction-1",
  "./app/result-correction-dialog.js?v=padelstar-result-correction-dialog-1",
  "./app/match-card.js?v=padelstar-match-card-13",
  ...
  "./app/remote-admin-actions.js?v=padelstar-remote-admin-actions-4",
  "./app/remote-player-score.js?v=padelstar-remote-player-score-4",
  "./app/score-actions.js?v=padelstar-score-actions-6",
  "./app/workspace-navigation.js?v=padelstar-workspace-navigation-5",
  "./app/app-events.js?v=padelstar-app-events-5",
  "./app/workspace-events.js?v=padelstar-workspace-events-2",
  ...
  "./app/app.js?v=padelstar-session-81",
  "./supabase-config.js",
