const cacheName = "padelstar-v316";
...
const appShell = [
  ...
  "./styles/feedback.css?v=padelstar-feedback-1",
  "./styles/scorer-panel.css?v=padelstar-scorer-panel-5",
  ...
  "./app/translations.js?v=padelstar-i18n-46",
  ...
  "./app/player-list.js?v=padelstar-player-list-2",
  "./app/cup-bracket.js?v=padelstar-cup-bracket-2",
  "./app/player-status.js?v=padelstar-player-status-1",
  "./app/player-next-match.js?v=padelstar-player-next-match-5",
  ...
  "./app/player-replacement.js?v=padelstar-player-replacement-1",
  "./app/player-state.js?v=padelstar-player-state-3",
  ...
  "./app/feedback.js?v=padelstar-feedback-1",
  ...
  "./app/match-card.js?v=padelstar-match-card-12",
  ...
  "./app/app.js?v=padelstar-session-70",
  "./supabase-config.js",
