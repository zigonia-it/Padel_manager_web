const cacheName = "padelstar-v207";
...
const appShell = [
  ...
  "./styles/ui-consistency.css?v=padelstar-ui-consistency-1",
  "./styles/privacy.css?v=padelstar-privacy-1",
  "./app/translations.js?v=padelstar-i18n-12",
  "./app/i18n-ui.js?v=padelstar-i18n-ui-1",
  "./app/storage.js?v=padelstar-storage-1",
  "./app/rendering.js?v=padelstar-rendering-1",
  "./app/remote-tournament.js?v=padelstar-remote-tournament-1",
  "./app/admin-actions.js?v=padelstar-admin-actions-1",
  ...
  "./app/cup-bracket.js?v=padelstar-cup-bracket-1",
  ...
  "./app/score-actions.js?v=padelstar-score-actions-1",
  "./app/workspace-navigation.js?v=padelstar-workspace-navigation-1",
  ...
  "./app/app.js?v=padelstar-session-28",
  "./supabase-config.js",
