const cacheName = "padelstar-v347";
...
const appShell = [
  ...
  "./styles/theme-light.css?v=padelstar-theme-light-7",
  ...
  "./app/bootstrap/app-meta.js?v=padelstar-app-meta-8",
  ...
  "./app/tv-mode.js?v=padelstar-tv-mode-10",
  ...
  "./app/app.js?v=padelstar-session-79",
  "./supabase-config.js",
