const cacheName = "padelstar-v350";
...
const appShell = [
  ...
  "./styles/components.css?v=padelstar-components-21",
  ...
  "./styles/workspace-nav.css?v=padelstar-workspace-nav-7",
  "./styles/podium.css?v=padelstar-podium-5",
  "./styles/lobby.css?v=padelstar-lobby-5",
  ...
  "./app/translations.js?v=padelstar-i18n-58",
  ...
  "./app/bootstrap/app-meta.js?v=padelstar-app-meta-11",
  ...
  "./app/app.js?v=padelstar-session-82",
  "./supabase-config.js",
