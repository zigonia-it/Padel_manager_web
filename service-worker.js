const cacheName = "padelstar-v303";
...
const appShell = [
  ...
  "./app/translations.js?v=padelstar-i18n-40",
  ...
  "./app/match-card.js?v=padelstar-match-card-8",
  ...
  "./app/score-actions.js?v=padelstar-score-actions-5",
  ...
  "./app/app.js?v=padelstar-session-64",
  "./supabase-config.js",
