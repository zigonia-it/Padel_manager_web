const cacheName = "padelstar-v285";
...
const appShell = [
  ...
  "./app/translations.js?v=padelstar-i18n-31",
  ...
  "./app/player-next-match.js?v=padelstar-player-next-match-2",
  ...
  "./app/app.js?v=padelstar-session-59",
  "./supabase-config.js",
