const cacheName = "padelstar-v360";
...
const appShell = [
  ...
  "./styles/styles.css?v=padelstar-ui-105",
  ...
  "./styles/create-wizard.css?v=padelstar-create-wizard-5",
  ...
  "./app/translations.js?v=padelstar-i18n-65",
  ...
  "./app/workspace-overview.js?v=padelstar-workspace-overview-3",
  ...
  "./app/state-manager.js?v=padelstar-state-3",
  ...
  "./app/bootstrap/app-meta.js?v=padelstar-app-meta-21",
  ...
  "./app/ui/app-renderer.js?v=padelstar-app-renderer-6",
  ...
  "./app/match-card.js?v=padelstar-match-card-16",
  "./app/backup-format.js?v=padelstar-backup-format-2",
  "./app/link-utils.js?v=padelstar-link-utils-2",
  "./app/tournament-state.js?v=padelstar-tournament-state-6",
  ...
  "./app/score-actions.js?v=padelstar-score-actions-7",
  ...
  "./app/app.js?v=padelstar-session-87",
  "./supabase-config.js",
