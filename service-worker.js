const cacheName = "padelstar-v170";
...
const appShell = [
  ...
  "./styles/components.css?v=padelstar-components-4",
  ...
  "./app/workspace-overview.js?v=padelstar-workspace-overview-1",
  ...
  "./app/admin-status.js?v=padelstar-admin-status-1",
  ...
  "./app/app.js?v=padelstar-session-27",
  "./supabase-config.js",
