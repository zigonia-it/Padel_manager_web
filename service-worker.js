const cacheName = "padelstar-v361";
...
const appShell = [
  ...
  "./app/translations.js?v=padelstar-i18n-66",
  ...
  "./app/large-score.js?v=padelstar-large-score-3",
  ...
  "./app/scoring-engine.js?v=padelstar-scoring-6",
  ...
  "./app/bootstrap/app-meta.js?v=padelstar-app-meta-22",
  ...
  "./app/match-card.js?v=padelstar-match-card-17",
  ...
  "./app/app.js?v=padelstar-session-88",
  "./supabase-config.js",
