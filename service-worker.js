const cacheName = "padelstar-v301";
...
const appShell = [
  ...
  "./styles/scorer-panel.css?v=padelstar-scorer-panel-1",
  ...
  "./app/translations.js?v=padelstar-i18n-38",
  ...
  "./app/match-card.js?v=padelstar-match-card-7",
  ...
  "./app/remote-admin-actions.js?v=padelstar-remote-admin-actions-2",
  "./app/remote-player-score.js?v=padelstar-remote-player-score-2",
  "./app/score-actions.js?v=padelstar-score-actions-4",
  ...
  "./app/app.js?v=padelstar-session-63",
  "./supabase-config.js",
