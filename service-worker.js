...
const appShell = [
  ...
  "./styles/layout.css?v=padelstar-layout-1",
  "./styles/components.css?v=padelstar-components-1",
  "./styles/modules.css?v=padelstar-modules-1",
  "./styles/styles.css?v=padelstar-ui-38",
  ...
  "./app/app.js?v=padelstar-session-14",
  "./supabase-config.js",
