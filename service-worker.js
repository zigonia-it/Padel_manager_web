...
const appShell = [
  ...
  "./app/translations.js?v=padelstar-i18n-26",
  ...
  "./app/bootstrap/dom-elements.js?v=padelstar-dom-elements-5",
  ...
  "./app/module-routing.js?v=padelstar-module-routing-2",
  ...
  "./app/app.js?v=padelstar-session-48",
  "./supabase-config.js",
