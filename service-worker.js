const cacheName = "padelstar-v276";
...
const appShell = [
  ...
  "./app/standings.js?v=padelstar-standings-2",
  ...
  "./app/bootstrap/dom-elements.js?v=padelstar-dom-elements-4",
  "./app/bootstrap/app-meta.js?v=padelstar-app-meta-3",
  ...
  "./app/app.js?v=padelstar-session-44",
  "./supabase-config.js",
