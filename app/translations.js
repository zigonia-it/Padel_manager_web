...
Object.assign(padelstarTranslations.nb, {
  ...
  "setup.nameHint": "Har du et vanlig navn? Legg til første bokstav i etternavnet, for eksempel «Anna K.». Da kan ikke navnet ditt forveksles med en annen.",
  ...
  "messages.duplicatePlayer": "{name} finnes allerede i spillerlisten. Legg til første bokstav i etternavnet, for eksempel «{name} K.».",
...
Object.assign(padelstarTranslations.en, {
  ...
  "setup.nameHint": "Common name? Add the first letter of your surname, for example “Anna K.”, so your name cannot be mixed up with someone else’s.", "profile.nameHint": "This name (or your nickname) is filled in when you join a tournament. If you have a common name, add the first letter of your surname, for example “Anna K.”.",
...
Object.assign(padelstarTranslations.nb, {
  ...
  "profile.nameHint": "Dette navnet (eller kallenavnet ditt) fylles inn når du blir med i en turnering. Har du et vanlig navn, legg til første bokstav i etternavnet, for eksempel «Anna K.».",
...
Object.assign(padelstarTranslations.nb, {
  ...
  "assistant.finding.too_few_players": "For få aktive spillere til å starte.",
  "assistant.finding.no_active_court": "Ingen aktiv bane.",
  "assistant.finding.cup_teams_missing": "Cupen mangler lag.",
  "assistant.finding.score_conflict": "Et resultat er flagget og venter på at admin avgjør det.",
...
Object.assign(padelstarTranslations.en, {
  ...
  "assistant.finding.too_few_players": "Too few active players to start.",
  "assistant.finding.no_active_court": "No active court.",
  "assistant.finding.cup_teams_missing": "The cup is missing teams.",
  "assistant.finding.score_conflict": "A result is flagged and waiting for the admin to decide it.",
  "admin.americanoFormat": "Americano",
  "admin.teamAmericanoFormat": "Team Americano",
  "admin.mexicanoFormat": "Mexicano",
  "admin.teamMexicanoFormat": "Team Mexicano",
...
Object.assign(padelstarTranslations.en, {
  ...
  "messages.duplicatePlayer": "{name} is already in the player list. Add the first letter of the surname, for example “{name} K.”.",
